...
def spec() -> list[tuple]:
    return [
        ...
        ("resolver_share_daily", "Omniston · Resolver share of volume",
         "Which resolvers win the flow, over time.", [
            ("chart", "Resolver share of volume", "chart",
             chart("area", "day", [("volume_usd", "Volume", "area")], "USD", "$0.0a",
                   stacking="normal", series_col="resolver")),
        ]),
...
def layout() -> list[tuple]:
    return [
        ...
        ("text", "## The resolver market", 6, 1),
        ("viz", "resolver_share_daily::chart", 6, 7),
